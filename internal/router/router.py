...
class Router:
    ...
    def register_router(self, app: Flask):
        ...
        # 3. Built-in plugin marketplace module
        ...
        # 4. Custom api-tools plugin module
        bp.add_url_rule(
            "/api-tools",
        ...
        # 6. Authorization and Authentication Module
        bp.add_url_rule(
        ...
        # 8. Register the Blueprint with the Application
