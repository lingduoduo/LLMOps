...
openapi_schema_string = """{"server": "https://baidu.com", "description": "123", "paths": {"/location": {"get": {"description": "Get local location", "operationId":"xxx", "parameters":[{"name":"location", "in":"query", "description":"Parameter description", "required":true, "type":"str"}]}}}}"""
...
class TestApiToolHandler:
    ...
    #     api_tool_provider = db.session.query(ApiToolProvider).filter_by(name="Imooc Learning Toolkit").one_or_none()
